...
export const PROJECTS = [
  {
    ...
    live_link: "https://playme-by-pritam.netlify.app/",
  },
  {
    ...
    live_link: "https://like-by-pritam.netlify.app/",
  },
  {
    title: "Pearl - A eCommerce app.",
    description:
    ...
    live_link: "https://pearl-by-pritam.netlify.app/",
  },
  {
    title: "Binary UI - A CSS framerwork",
    description:
      "Binary UI is a lightweight, modern CSS framework designed to make it easy to build beautiful and responsive user interfaces. It is built on top of the latest web technologies and is designed to be highly customizable, making it a versatile tool for web developers.",
    img: "https://res.cloudinary.com/dhqxln7zi/image/upload/v1679164270/Screenshot_2023-03-19_000058_itlfsq.png",
    stack: ["HTML", "CSS", "JavaScript"],
    github_icon: <FaIcons.FaGithub />,
    link_icon: <FaIcons.FaLink />,
    github_link: "https://github.com/pritam-kr/BinaryUI",
    live_link: "https://binary-ui.netlify.app/",
  },

  {
    title: "Food Recipe - Search by Country name.",
    description:
      "This food recipe app for global cuisine enthusiasts! With World Recipes, users can easily search for their favorite recipes from different countries. The app features a user-friendly interface and a powerful search engine that allows users to find recipes based on country names.",
    img: "https://res.cloudinary.com/dhqxln7zi/image/upload/v1679167977/Screenshot_2023-03-19_010231_awuoih.png",
